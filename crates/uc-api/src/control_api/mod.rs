...
pub fn router(state: AppState) -> Router {
    Router::new()
        ...
        .route(
            "/api/1.0/unity-control/scim2/Users/:id",
            get(scim2::get_user)
                .put(scim2::update_user)
                .delete(scim2::delete_user)
                .patch(scim2::patch_user),
        )
        .route(
            "/api/1.0/unity-control/scim2/Me",
            get(scim2::get_me).patch(scim2::patch_me),
        )
